...
class ExportTab:
    ...
    def build(self):
        export_frame = tk.LabelFrame(self.parent, text="画像ファイルとして保存")
        ...
        tk.Entry(export_frame, textvariable=self.app.export_width_var).grid(
        ...
        tk.Entry(export_frame, textvariable=self.app.export_height_var).grid(
